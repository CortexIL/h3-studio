  ...
  return {
    ...
    config: {
      presets: {
        ...
        sharp: { width: 1344, height: 768, steps: 6, lora: 'sharp.safetensors', lora_strength: 0.9, shift_video: 8, shift_audio: 3 },
      ...
      mock: false,
      keep_audio: true,
      estimate: { gpu: 'NVIDIA L40', confidence: 'estimated', minutes_per_10s: { draft: 4.8, final: 65, turbo: 8.7, balanced: 17.4, sharp: 13, hd720: 65 } },
      prompt_helper: true,
    },
