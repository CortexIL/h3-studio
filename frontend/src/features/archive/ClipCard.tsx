import { Download, Expand, Film, MoreHorizontal, Play, Repeat, RotateCcw, Trash2 } from 'lucide-react'
...
function ClipCardImpl({ clip }: { clip: Clip }) {
  ...
  return (
    <article className="group flex flex-col overflow-hidden rounded-lg border bg-card transition-colors hover:border-primary/40">
      <button
        type="button"
      ...
      <div className="flex flex-1 items-start gap-1 p-3">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button size="icon" variant="ghost" className="-mr-1 size-8 shrink-0" aria-label="Clip actions">
